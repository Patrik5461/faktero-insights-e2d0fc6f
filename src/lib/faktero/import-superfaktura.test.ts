...
describe("prehľad faktúr zo SuperFaktúry", () => {
  ...
  const RIADKY = [
    {
      "Číslo dokladu": "2026039",
      VS: "2026000048",
      Odberateľ: "Ana Bobáňová",
      "Odberateľ IČO": "",
      "Odberateľ DIČ": "",
      "Odberateľ IČ DPH": "SK2020304050",
      "Odberateľ adresa": "Hlavná 1",
      "Krajina odberateľa": "SK",
      "Odberateľ email": "a@b.sk",
      "Odberateľ telefón": "0900123456",
      "Dátum vystavenia": "10.08.2026",
      "Dátum splatnosti": "24.08.2026",
      "Dátum dodania": "10.08.2026",
      Mena: "EUR",
      Suma: "70,00",
      Stav: "Uhradená",
      Poznámka: "",
      Položky: "Apple AirPods Pro , DPD , Dobierkou ,",
      "Počet položiek": "3",
      "Názov / Popis": "Predaj tovaru",
    },
  ];
