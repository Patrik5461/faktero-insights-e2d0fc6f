    ...
    Items: [
      {
        ...
        Items: [
          { Text: "Montážne práce", Quantity: 10, Unit: "h", UnitPrice: 10, VatRateType: "BasicVatRate", PriceWithoutVat: 100, Vat: 23, PriceWithVat: 123 },
          { Text: "Liek", Quantity: 2, Unit: "ks", UnitPrice: 10, VatRateType: "SecondReducedVatRate", PriceWithoutVat: 20, Vat: 1, PriceWithVat: 21 },
        ],
