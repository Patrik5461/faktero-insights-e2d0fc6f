...
const CATS: Cat[] = [
  ...
  {
    to: "/pomoc/oss",
    label: "OSS — predaj do EÚ",
    desc: "Hranica 10 000 €, sadzby štátu zákazníka a štvrťročné podklady.",
    icon: Percent,
    available: true,
    skupina: "Účtovníctvo",
  },
  ...
  {
    to: "/pomoc/zamestnanci",
    label: "Zamestnanci",
    desc: "Karty, zmluvy zo šablón, dochádzka a lehoty.",
    icon: Users,
    available: true,
    skupina: "Účet a vývoj",
  },
  {
    to: "/pomoc/zabezpecenie",
    label: "Zabezpečenie účtu",
    desc: "Dvojfaktorové overenie, heslá, prístupy a zrušenie účtu.",
    icon: Lock,
    available: true,
    skupina: "Účet a vývoj",
  },
