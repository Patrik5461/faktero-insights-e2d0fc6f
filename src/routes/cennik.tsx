...
const FAQ = [
  { q: "Je naozaj 15 dní zdarma bez karty?", a: "Áno. Začnete bez platobnej karty a po skúšobnej dobe sa rozhodnete, či si vyberiete platený plán." },
...
export const Route = createFileRoute("/cennik")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Jednoduchý cenník: Starter 9 € / mesiac, Business 24 € / mesiac, Enterprise na mieru. 15 dní zdarma bez karty." },
      { property: "og:title", content: "Cenník Faktero" },
      { property: "og:description", content: "Starter, Business a Enterprise plány. 15 dní zdarma." },
    ],
  }),
      ...
      <section className="border-b border-border/60 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="mx-auto max-w-6xl px-6 py-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            15 dní zdarma bez platobnej karty. Bezpečné platby cez GoPay.
          </p>
        </div>
      </section>
