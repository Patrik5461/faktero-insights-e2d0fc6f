...
const PLANS = [
  ...
  },
  {
    ...
    price: "19 €",
    period: "/ mesiac",
    tagline: "Pre rastúce tímy — API, GPS a viac firiem.",
    features: [
      "Všetko zo Starter",
      "Neobmedzené faktúry",
      "10 používateľov",
...
export const Route = createFileRoute("/cennik")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Jednoduchý cenník: Starter 9 € / mes, Business 19 € / mes, Premium 39 € / mes, Enterprise na mieru. 2 Mesiace zdarma bez karty." },
      { property: "og:title", content: "Cenník Faktero" },
      { property: "og:description", content: "Starter, Business, Premium a Enterprise plány. 2 Mesiace zdarma." },
    ],
  }),
