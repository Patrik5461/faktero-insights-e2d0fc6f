...
function Stranka() {
  ...
  const [kind, setKind] = useState<"leasing" | "uver">("leasing");
  ...
  /* Náhľad sa počíta tou istou funkciou, akú použije server — nech človek vidí
     presne to, čo mu vznikne, a vie to porovnať so zmluvou ešte pred uložením. */
  ...
  }, [principal, rate, months, firstDue, payment, vat, residual]);
  ...
  async function odosli() {
    ...
    try {
      ...
      toast.success(`Zmluva uložená, kalendár má ${r.splatok} splátok.`);
      navigate({ to: "/financovanie/$id", params: { id: r.id } });
    } catch (e: unknown) {
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_20rem]">
          <div className="space-y-5 rounded-xl border bg-card p-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                />
                <p className="mt-1 text-xs text-muted-foreground">
                  Zaplatená na začiatku — do kalendára nevstupuje, financovanú sumu zadajte už bez
                  nej.
                </p>
              </div>
              <div>
          ...
          <div className="space-y-4">
                ...
                <dl className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <dd className="tabular-nums">
                      {formatujSumu(nahlad.suhrn.zaplatiSpolu, "EUR")}
                    </dd>
                  </div>
                  <div className="flex justify-between">
            ...
            <p className="px-1 text-xs leading-relaxed text-muted-foreground">
              ...
              nezhodujú so zmluvou, vyplňte splátku ručne; kalendár sa dopočíta z nej.
            </p>
          </div>
        </div>
      </PageBody>
